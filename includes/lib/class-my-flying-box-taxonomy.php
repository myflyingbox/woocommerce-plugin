...
class My_Flying_Box_Taxonomy {
	...
	public function register_taxonomy () {
        ...
        $labels = array(
            ...
            'update_item' => sprintf( __( 'Update %s' , 'my-flying-box' ), $this->single ),
            'add_new_item' => sprintf( __( 'Add New %s' , 'my-flying-box' ), $this->single ),
            'new_item_name' => sprintf( __( 'New %s Name' , 'my-flying-box' ), $this->single ),
            'parent_item' => sprintf( __( 'Parent %s' , 'my-flying-box' ), $this->single ),
            'parent_item_colon' => sprintf( __( 'Parent %s:' , 'my-flying-box' ), $this->single ),
            'search_items' =>  sprintf( __( 'Search %s' , 'my-flying-box' ), $this->plural ),
            'popular_items' =>  sprintf( __( 'Popular %s' , 'my-flying-box' ), $this->plural ),
            'separate_items_with_commas' =>  sprintf( __( 'Separate %s with commas' , 'my-flying-box' ), $this->plural ),
            'add_or_remove_items' =>  sprintf( __( 'Add or remove %s' , 'my-flying-box' ), $this->plural ),
            'choose_from_most_used' =>  sprintf( __( 'Choose from the most used %s' , 'my-flying-box' ), $this->plural ),
